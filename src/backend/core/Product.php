...
class Product extends QueryBuilder
{
    ...
    {
        return array($this->sku, $this->name, $this->price, $this->type, $this->attribute, $this->description);
    }
    ...
    {
        return $this->insert(array($this->sku, $this->name, $this->price, $this->type, $this->attribute, $this->description));
    }
